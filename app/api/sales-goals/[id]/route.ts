...
export async function PATCH(request: NextRequest, { params }: { params: { id: string } }) {
  try {
    ...
    return NextResponse.json({
      data: {
        id: data.id, teamMemberId: data.team_member_id, year: data.year, month: data.month,
        revenueTarget: data.revenue_target, bookingsTarget: data.bookings_target,
        estimatesTarget: data.estimates_target, callsTarget: data.calls_target,
