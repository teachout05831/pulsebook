...
import { ChevronLeft, ChevronRight, Plus, Search, X, FileText } from "lucide-react";
import {
  Table,
  TableBody,
  TableCell,
  ...
  return (
    <div className="flex flex-col items-center justify-center py-12">
      ...
      <h3 className="text-lg font-medium">
        {isFiltered ? "No estimates found" : "No estimates yet"}
      </h3>
...
export default function EstimatesPage() {
  ...
  const { query, result } = useList<Estimate>({
    resource: "estimates",
    pagination: {
      currentPage,
      pageSize,
