...
const BASE_URL = `https://task-system-nine.vercel.app/api/v1/whiteboards/${WHITEBOARD_ID}/items`;
...
// Layout: 3 columns, decent size cards
...
for (let i = 0; i < resources.length; i++) {
  ...
  console.log(`  Status: ${response.status}, Response: ${text || '(empty)'}`);
