...
import { CONTRACTS_TABLE_COLUMNS } from "../constants";

interface ContractsColumnPickerProps {
  visibleColumns: string[];
  onToggle: (columnId: string) => void;
  onReset: () => void;
}

export function ContractsColumnPicker({ visibleColumns, onToggle, onReset }: ContractsColumnPickerProps) {
  return (
    <Popover>
